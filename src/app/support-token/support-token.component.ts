...
import { SupportTokenService } from '../support-token/support-token.service';
...
@Component({
  ...
  providers : [SupportTokenService]
})
export class SupportTokenComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute,
    ...
    private supportTokenService: SupportTokenService) {}    
